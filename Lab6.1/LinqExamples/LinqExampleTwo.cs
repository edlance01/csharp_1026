    ...
    */
    class Program
    {
            ...
            var myTasks = new List<TodoItem>
        {
            ...
            var stats = myTasks
                .GroupBy(t => t.Category) // Group tasks by their category
                .Select(group => new // Create a new anonymous object for each group
                {
                    CategoryName = group.Key, // The category name (key of the group)
                    Count = group.Count(),
